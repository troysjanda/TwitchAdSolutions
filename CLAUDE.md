...
Bump `@version` (userscript header) and `ourTwitchAdSolutionsVersion` together for functional changes. Current: vaft 66.2.0/75, video-swap-new 1.86/54, strip 1.9/26. Testing: vaft 637.0.0/637, video-swap-new -/619.
